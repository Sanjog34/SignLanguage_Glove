...
$$\mathbf{x} = \left[ \text{idxUp}, \text{idxLow}, \text{midUp}, \text{midLow}, \text{ringUp}, \text{ringLow}, \text{thumb}, \text{pinky}, ax, ay, az, gx, gy, gz, \text{acc\_g}x, \text{acc\_g}y, \text{acc\_g}z \right]$$
